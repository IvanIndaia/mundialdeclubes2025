...
function whatsapp() {
  ...
  let text = `APOSTA *FUTBR* %0ACOPA DO MUNDO CATAR-2022%0A%0A--------------------------- %0A   Disputa do 3º Lugar%0A--------------------------- %0A${A2} NaN X NaN ${B2} %0A%0A--------------------------- %0A               Final%0A--------------------------- %0A${A1}  ${plac[2]} X ${plac[3]} ${B1}`
