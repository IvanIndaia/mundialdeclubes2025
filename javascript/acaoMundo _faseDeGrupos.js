...
function whatsapp() {
  ...
  let textCD = `Grupo C %0A-------------------- %0ABayern de Munique ${plac[24]} X ${plac[25]} Auckland City %0ABoca Juniors ${plac[26]} X ${plac[27]} Benfica %0ABenfica ${plac[28]} X ${plac[29]} Auckland City %0ABayern de Monique ${plac[30]} X ${plac[31]} Boca Juniors %0ABenfica ${plac[32]} X ${plac[33]} Bayern de Munique %0AAuckland City ${plac[34]} X ${plac[35]} Boca Juniors %0A%0A--------------------%0AGrupo D%0A-------------------- %0AChelsea ${plac[36]} X ${plac[37]} Los Angeles FC %0AFlamengo ${plac[38]} X ${plac[39]} Espérance %0AFlamengo ${plac[40]} X ${plac[41]} Chelsea %0ALos Angeles FC ${plac[42]} X ${plac[43]} Espérance %0AEspérance ${plac[44]} X ${plac[45]} Chelsea %0ALos Angeles FC ${plac[46]} X ${plac[47]} Flamengo %0A%0A-------------------- %0A`
